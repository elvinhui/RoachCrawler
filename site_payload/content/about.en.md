...
- **Cloud & DevOps** — AWS, GCP, Azure, Kubernetes, CI/CD pipelines
- **Cybersecurity** — threat detection, penetration testing, security architecture
- **Developer Tools** — databases, backend frameworks, productivity tools
